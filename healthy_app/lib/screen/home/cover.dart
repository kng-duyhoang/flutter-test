    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Column(
        ...
        children: [
          ...
          const Text('Have you', style: TextStyle(fontSize: 30, color: Colors.white),),
          const Text('exercised today?', style: TextStyle(fontSize: 30, color: Colors.white),)
        ],
      ),
      const SizedBox(
        height: 10,
      ...
      SizedBox(
        ...
        child: DecoratedBox(
          ...
          child: Row(
            children: [
              BoxText(data: user.username, label: 'weight'),
              SizedBox(
                width: 2,
                height: 30,
                child: Container(
              ...
              BoxText(data: user.height, label: 'height'),
              SizedBox(
                width: 2,
                height: 30,
                child: Container(
              ...
              const BoxText(data: '45%', label: 'percent'),
            ],
          ),
        ),
      ),
